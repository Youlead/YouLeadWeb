                ...
                $(form).ajaxSubmit({
                    ...
                    success: function (data) {
                        ...
                        if (data.success == 'true') {
                            parent.location.href = "background_thread.aspx";
                        } else {
    ...
    <div class="hd">
        <div class="share_area">
            ...
            <div class="share_table" style="padding: 0px;">
                <form id="contentForm" onsubmit="onPostPageSubmit(this);return false;" action="/BBS/ajax/form.aspx?action=postAllInOne"
                method="post">
