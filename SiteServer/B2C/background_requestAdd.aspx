<%@ Page Language="C#" validateRequest="false" Inherits="SiteServer.B2C.BackgroundPages.BackgroundRequestAdd" %>
      ...
      <table class="table noborder">
        ...
        <tr>
          ...
          <td>
            ...
            <asp:Literal id="ltlAdminUserName" runat="server" />
          </td>
        </tr>
          ...
          <table class="table noborder">
            <tr>
             <td align="right">用户：</td>
              <td colspan="3">
                <input id="userName" name="userName" value="<%=GetValue("UserName")%>" type="hidden">
                <a id="selectUserName" href="javascript:;" onclick="<%=GetValue("SelectUserNameClick")%>" class="btn btn-info"><%=GetValue("SelectUserName")%></a>
                <script language="javascript">
