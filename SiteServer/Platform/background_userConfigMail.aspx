...
<form class="form-inline" runat="server">
  ...
  <div class="popover-content">
    ...
    <table class="table noborder table-hover">
      ...
      <tr>
        <td width="200"><bairong:help ID="Help1" HelpText="发送邮件中显示的发件人" Text="显示发件人：" runat="server" ></bairong:help></td>
      ...
      <tr>
        ...
        <td><asp:TextBox Columns="35" MaxLength="50" id="MailServerUserName" runat="server" />
          ...
          <asp:RegularExpressionValidator runat="server" ControlToValidate="MailServerUserName" ValidationExpression="[^']+" errorMessage=" *" foreColor="red" display="Dynamic" /></td>
      </tr>
      <tr>
