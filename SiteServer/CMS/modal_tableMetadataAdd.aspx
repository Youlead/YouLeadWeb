<%@ Page Language="C#" Inherits="SiteServer.CMS.BackgroundPages.Modal.TableMetadataAdd" %>
...
<bairong:alerts runat="server"></bairong:alerts>
  ...
  <table class="table table-noborder table-hover">
    <tr>
      ...
      <td><asp:TextBox Columns="25" MaxLength="50" id="AttributeName" runat="server" />
        ...
        <asp:RegularExpressionValidator runat="server" ControlToValidate="AttributeName"
                ValidationExpression="[a-zA-Z0-9_]+" ErrorMessage="<br/>只允许包含字母、数字以及下划线" Display="Dynamic" /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><bairong:help HelpText="此字段是否允许为空，如果不允许为空，建议添加数据库默认值。" Text="是否允许为空：" runat="server" ></bairong:help></td>
      <td><asp:RadioButtonList id="CanBeNull" RepeatDirection="Horizontal" class="noborder" runat="server">
          <asp:ListItem Text="是" Selected="True" />
          <asp:ListItem Text="否" />
        </asp:RadioButtonList></td>
    </tr>
    <tr>
      <td><bairong:help HelpText="此字段的默认值" Text="数据库默认值：" runat="server" ></bairong:help></td>
      <td><asp:TextBox Columns="25" MaxLength="50" id="DBDefaultValue" runat="server" /></td>
    </tr>
  </table>
