<%@ Page Language="C#" Inherits="BaiRong.BackgroundPages.Upgrade" %>
                ...
                <TBODY>
                  ...
                  <tr>
                    <td valign="top" align="right" colspan="2"><span class="im">我已经阅读并同意此协议</span>
                      ...
                      &nbsp;
                      <asp:button OnClick="btnStep1_Click" class="btn byellow" tabindex="3" Text="开始升级" runat="server"></asp:button></td>
                  </tr>
                </tbody>
              </table>
            </asp:PlaceHolder>
            <asp:PlaceHolder ID="phStep2" runat="server">
              <DIV id="Upgrade1">
                <DIV class=pr-title>
                  ...
                  <DIV>&nbsp;<img src="../../SiteFiles/bairong/Icons/waiting.gif" width="220" height="19" align="middle" /></DIV>
                </DIV>
                <DIV class=pr-title>
                ...
                <DIV class=pr-title>
                  <H3 style="color:#06F">升级系统文件</H3>
                  <img src="../../SiteFiles/bairong/Icons/waiting.gif" width="220" height="19" align="middle" />
                </DIV>
                <DIV class=pr-title>
                  <H3 style="color:#06F">升级平台数据库</H3>
                  <DIV>&nbsp;升级平台数据库。 </DIV>
