...
--
-- Date Created : Saturday, August 03, 2013 13:31:33
...
CREATE SEQUENCE SITESERVER_DISKDIRECTORY_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_DISKFILE_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVINTERACTLOG_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVINTERACTREMARK_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVINTERACTREPLY_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVINTERACTTYPE_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVPUBLICAPPLY_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVPUBLICAPPLYLOG_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVPUBLICAPPLYREMARK_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVPUBLICAPPLYREPLY_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVPUBLICCATEGORY_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_GOVPUBLICIR_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_RELATEDFIELDITEM_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE SEQUENCE SITESERVER_VOTE_SEQ
    START WITH 1
    INCREMENT BY 1
    NOMINVALUE
    NOMAXVALUE
...
CREATE TABLE siteserver_GatherFileRule(
    ...
    LastGatherDate                   TIMESTAMP(6)      DEFAULT sysdate,
...
CREATE TABLE siteserver_GovInteractChannel(
    NodeID                    NUMBER(38, 0)     NOT NULL,
    PublishmentSystemID       NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    ApplyStyleID              NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    QueryStyleID              NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    DepartmentIDCollection    NVARCHAR2(255)    DEFAULT '',
    Summary                   NVARCHAR2(255)    DEFAULT '',
    CONSTRAINT PK_siteserver_GovInteractChannel PRIMARY KEY (NodeID)
)
GO



CREATE TABLE siteserver_GovInteractLog(
    LogID                  NUMBER(38, 0)     NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    NodeID                 NUMBER(38, 0)     NOT NULL,
    ContentID              NUMBER(38, 0),
    DepartmentID           NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    UserName               NVARCHAR2(255)    DEFAULT '',
    LogType                VARCHAR2(50)      DEFAULT '',
    IPAddress              VARCHAR2(50)      DEFAULT '',
    AddDate                TIMESTAMP(6)      DEFAULT sysdate NOT NULL,
    Summary                NVARCHAR2(255)    DEFAULT '',
    CONSTRAINT PK_siteserver_GovInteractLog PRIMARY KEY (LogID)
)
GO



CREATE TABLE siteserver_GovInteractPermissions(
    UserName       NVARCHAR2(50)     NOT NULL,
    NodeID         NUMBER(38, 0)     NOT NULL,
    Permissions    NVARCHAR2(255)    DEFAULT '',
    CONSTRAINT PK_siteserver_GovInteractAdministrato PRIMARY KEY (UserName, NodeID)
)
GO



CREATE TABLE siteserver_GovInteractRemark(
    RemarkID               NUMBER(38, 0)     NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    NodeID                 NUMBER(38, 0)     NOT NULL,
    ContentID              NUMBER(38, 0),
    RemarkType             VARCHAR2(50)      DEFAULT '',
    Remark                 NVARCHAR2(255)    DEFAULT '',
    DepartmentID           NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    UserName               NVARCHAR2(255)    DEFAULT '',
    AddDate                TIMESTAMP(6)      DEFAULT sysdate NOT NULL,
    CONSTRAINT PK_siteserver_GovInteractRemark PRIMARY KEY (RemarkID)
)
GO



CREATE TABLE siteserver_GovInteractReply(
    ReplyID                NUMBER(38, 0)     NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    NodeID                 NUMBER(38, 0)     NOT NULL,
    ContentID              NUMBER(38, 0),
    Reply                  NCLOB,
    FileUrl                NVARCHAR2(255)    DEFAULT '',
    DepartmentID           NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    UserName               NVARCHAR2(255)    DEFAULT '',
    AddDate                TIMESTAMP(6)      DEFAULT sysdate NOT NULL,
    CONSTRAINT PK_siteserver_GovInteractReply PRIMARY KEY (ReplyID)
)
GO



CREATE TABLE siteserver_GovInteractType(
    TypeID                 NUMBER(38, 0)    NOT NULL,
    TypeName               NVARCHAR2(50)    DEFAULT '',
    NodeID                 NUMBER(38, 0)    DEFAULT 0 NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)    DEFAULT 0 NOT NULL,
    Taxis                  NUMBER(38, 0)    DEFAULT 0 NOT NULL,
    CONSTRAINT PK_siteserver_GovInteractType PRIMARY KEY (TypeID)
)
GO



CREATE TABLE siteserver_GovPublicApply(
    ID                     NUMBER(38, 0)     NOT NULL,
    StyleID                NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    IsOrganization         VARCHAR2(18)      DEFAULT '',
    CivicName              NVARCHAR2(255)    DEFAULT '',
    CivicOrganization      NVARCHAR2(255)    DEFAULT '',
    CivicCardType          NVARCHAR2(255)    DEFAULT '',
    CivicCardNo            NVARCHAR2(255)    DEFAULT '',
    CivicPhone             VARCHAR2(50)      DEFAULT '',
    CivicPostCode          VARCHAR2(50)      DEFAULT '',
    CivicAddress           NVARCHAR2(255)    DEFAULT '',
    CivicEmail             NVARCHAR2(255)    DEFAULT '',
    CivicFax               VARCHAR2(50)      DEFAULT '',
    OrgName                NVARCHAR2(255)    DEFAULT '',
    OrgUnitCode            NVARCHAR2(255)    DEFAULT '',
    OrgLegalPerson         NVARCHAR2(255)    DEFAULT '',
    OrgLinkName            NVARCHAR2(255)    DEFAULT '',
    OrgPhone               VARCHAR2(50)      DEFAULT '',
    OrgPostCode            VARCHAR2(50)      DEFAULT '',
    OrgAddress             NVARCHAR2(255)    DEFAULT '',
    OrgEmail               NVARCHAR2(255)    DEFAULT '',
    OrgFax                 VARCHAR2(50)      DEFAULT '',
    Title                  NVARCHAR2(255)    DEFAULT '',
    Content                NCLOB             DEFAULT '',
    Purpose                NVARCHAR2(255)    DEFAULT '',
    IsApplyFree            VARCHAR2(18)      DEFAULT '',
    ProvideType            VARCHAR2(50)      DEFAULT '',
    ObtainType             VARCHAR2(50)      DEFAULT '',
    DepartmentName         NVARCHAR2(255)    DEFAULT '',
    DepartmentID           NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    AddDate                TIMESTAMP(6)      DEFAULT sysdate NOT NULL,
    QueryCode              NVARCHAR2(255)    DEFAULT '',
    State                  VARCHAR2(50)      DEFAULT '',
    CONSTRAINT PK_siteserver_GovPublicApply PRIMARY KEY (ID)
)
GO



CREATE TABLE siteserver_GovPublicApplyLog(
    LogID                  NUMBER(38, 0)     NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    ApplyID                NUMBER(38, 0),
    DepartmentID           NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    ...
    AddDate                TIMESTAMP(6)      DEFAULT sysdate NOT NULL,
    Summary                NVARCHAR2(255)    DEFAULT '',
    CONSTRAINT PK_siteserver_GovPublicApplyLog PRIMARY KEY (LogID)
)
GO



CREATE TABLE siteserver_GovPublicApplyRemark(
    RemarkID               NUMBER(38, 0)     NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    ApplyID                NUMBER(38, 0),
    RemarkType             VARCHAR2(50)      DEFAULT '',
    Remark                 NVARCHAR2(255)    DEFAULT '',
    DepartmentID           NUMBER(38, 0)     DEFAULT 0,
    UserName               NVARCHAR2(255)    DEFAULT '',
    AddDate                TIMESTAMP(6)      DEFAULT sysdate NOT NULL,
    CONSTRAINT PK_siteserver_GovPublicApplyRemark PRIMARY KEY (RemarkID)
)
GO



CREATE TABLE siteserver_GovPublicApplyReply(
    ReplyID                NUMBER(38, 0)     NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    ApplyID                NUMBER(38, 0),
    Reply                  NCLOB,
    ...
    UserName               NVARCHAR2(255)    DEFAULT '',
    AddDate                TIMESTAMP(6)      DEFAULT sysdate NOT NULL,
    CONSTRAINT PK_siteserver_GovPublicApplyReply PRIMARY KEY (ReplyID)
)
GO



CREATE TABLE siteserver_GovPublicCategory(
    CategoryID             NUMBER(38, 0)     NOT NULL,
    ClassCode              NVARCHAR2(50)     DEFAULT '',
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0,
    CategoryName           NVARCHAR2(255)    DEFAULT '',
    CategoryCode           VARCHAR2(50)      DEFAULT '',
    ...
    CONSTRAINT PK_siteserver_GovPublicCategory PRIMARY KEY (CategoryID)
)
GO



CREATE TABLE siteserver_GovPublicCategoryClass(
    ClassCode               NVARCHAR2(50)     DEFAULT '' NOT NULL,
    PublishmentSystemID     NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    ClassName               NVARCHAR2(255)    DEFAULT '',
    IsSystem                VARCHAR2(18)      DEFAULT '',
    IsEnabled               VARCHAR2(18)      DEFAULT '',
    ContentAttributeName    VARCHAR2(50)      DEFAULT '',
    Taxis                   NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    Description             NVARCHAR2(255)    DEFAULT '',
    CONSTRAINT PK_siteserver_GovPublicCategoryClass PRIMARY KEY (ClassCode, PublishmentSystemID)
)
GO



CREATE TABLE siteserver_GovPublicChannel(
    NodeID                 NUMBER(38, 0)     NOT NULL,
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    Code                   NVARCHAR2(50)     DEFAULT '',
    Summary                NVARCHAR2(255)    DEFAULT '',
    CONSTRAINT PK_siteserver_GovPublicChannel PRIMARY KEY (NodeID)
)
GO



CREATE TABLE siteserver_GovPublicIdentifierRule(
    RuleID                 NUMBER(38, 0)     NOT NULL,
    RuleName               NVARCHAR2(255)    DEFAULT '',
    PublishmentSystemID    NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    IdentifierType         VARCHAR2(50)      DEFAULT '',
    MinLength              NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    Suffix                 VARCHAR2(50)      DEFAULT '',
    FormatString           VARCHAR2(50)      DEFAULT '',
    AttributeName          VARCHAR2(50)      DEFAULT '',
    Sequence               NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    Taxis                  NUMBER(38, 0)     DEFAULT 0 NOT NULL,
    SettingsXML            NCLOB             DEFAULT '',
    CONSTRAINT PK_siteserver_GovPublicIdentifierRule PRIMARY KEY (RuleID)
)
GO
...
CREATE TABLE siteserver_TagStyle(
    ...
    StyleName              NVARCHAR2(50)    DEFAULT '',
    ElementName            VARCHAR2(50)     DEFAULT '',
    PublishmentSystemID    NUMBER(38, 0)    DEFAULT 0 NOT NULL,
    IsTemplate             VARCHAR2(18)     DEFAULT '',
    StyleTemplate          NCLOB            DEFAULT '',
    ScriptTemplate         NCLOB            DEFAULT '',
...
CREATE TABLE siteserver_Template(
    ...
    PublishmentSystemID    NUMBER(38, 0)    NOT NULL,
    TemplateName           NVARCHAR2(50)    DEFAULT '',
    TemplateType           VARCHAR2(50)     DEFAULT '',
    RelatedFileName        NVARCHAR2(50)    DEFAULT '',
    CreatedFileFullName    NVARCHAR2(50)    DEFAULT '',
...
ALTER TABLE siteserver_GovInteractChannel ADD CONSTRAINT FK_siteserver_GIC_N 
    FOREIGN KEY (NodeID)
    REFERENCES siteserver_Node(NodeID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovInteractLog ADD CONSTRAINT FK_RIC_RIL 
    FOREIGN KEY (NodeID)
    REFERENCES siteserver_GovInteractChannel(NodeID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovInteractPermissions ADD CONSTRAINT FK_GIC_GIA 
    FOREIGN KEY (NodeID)
    REFERENCES siteserver_GovInteractChannel(NodeID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovInteractRemark ADD CONSTRAINT FK_GIC_GIRe 
    FOREIGN KEY (NodeID)
    REFERENCES siteserver_GovInteractChannel(NodeID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovInteractReply ADD CONSTRAINT FK_GIC_GIR 
    FOREIGN KEY (NodeID)
    REFERENCES siteserver_GovInteractChannel(NodeID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovInteractType ADD CONSTRAINT FK_GIC_GIT 
    FOREIGN KEY (NodeID)
    REFERENCES siteserver_GovInteractChannel(NodeID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovPublicApplyLog ADD CONSTRAINT FK_siteserver_GPA_GPAL 
    FOREIGN KEY (ApplyID)
    REFERENCES siteserver_GovPublicApply(ID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovPublicApplyRemark ADD CONSTRAINT FK_siteserver_GPARemark_GPAL 
    FOREIGN KEY (ApplyID)
    REFERENCES siteserver_GovPublicApply(ID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovPublicApplyReply ADD CONSTRAINT FK_siteserver_GPAReply_GPAL 
    FOREIGN KEY (ApplyID)
    REFERENCES siteserver_GovPublicApply(ID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovPublicCategory ADD CONSTRAINT FK_siteserver_GPC_GPCC 
    FOREIGN KEY (ClassCode, PublishmentSystemID)
    REFERENCES siteserver_GovPublicCategoryClass(ClassCode, PublishmentSystemID) ON DELETE CASCADE
GO


ALTER TABLE siteserver_GovPublicChannel ADD CONSTRAINT FK_siteserver_GPC_N 
    FOREIGN KEY (NodeID)
    REFERENCES siteserver_Node(NodeID) ON DELETE CASCADE
GO
