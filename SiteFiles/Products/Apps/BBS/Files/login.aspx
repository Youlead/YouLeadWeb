...
<div class="hd">
  ...
  <div class="share_area">
    ...
    <div class="share_table">
      <form id="loginForm" onsubmit="onLoginPageSubmit(this, '<%=base.returnUrl%>');return false;" action="/bbs_test/ajax/form.aspx?publishmentSystemID=866&action=login" method="post">
...
<%if (base.IsRegisterAllowed){%><a id="aRegister" class="red14" href="javascript:void(0);">注册成为会员</a><%}%>
