<%@ Page Language="c#" Inherits="SiteServer.BBS.Pages.Dialog.UpDown" Trace="False" %>
    ...
    <table width="100%" class="dtb">
      <tbody>
        <tr class="tr3 line">
          ...
          <td><label class="mr20">
              <input checked="checked" type="radio" name="type" value="Up" />
              提升</label>
            <label>
