...
<head>
<title>产品服务区 - SiteServer BBS 论坛 - Powered by SiteServer BBS</title>
...
function gotoAdvancedUrl() {
    ...
    location.href = '/BBS/post.aspx?forumID=742';
}
KE.show({
    id : 'content',
...
<div class="hd">
    ...
    <div class="share_p"><img src="../images/ico_position.gif" />
            <a href="/BBS/">SiteServer BBS 论坛</a>><a href="/BBS/forums/742.aspx">产品服务区</a>
          </div>
  </div>
        <!--子版块开始-->
        <div class="share_area sha_bot_line" style="margin-bottom:10px;"><div class="share_tit"><span class="y"></span><h2><a href="/BBS/forums/742.aspx">产品服务区</a></h2></div><div class="share_table sha_bot_line"><table cellspacing="0" align="Center" style="width:100%;border-collapse:collapse;">
	<tr>
		<td class="fl_g" align="left" valign="top" style="width:33.3%;"><div class="fl_icn_g"><a href="/BBS/forums/743.aspx">
<%if (ForumUtils.IsNewThread(743)){%><img src="../images/forum_new.gif" /><%}else{%><img src="../images/forum.gif" /><%}%>
</a></div><dl><dt><a href="/BBS/forums/743.aspx"><strong>产品发布区</strong></a><em class="xi1"> 
                    (<%=ForumUtils.GetTodayThreadAndPostCount(743)%>)
                     </em></dt><dd><em>主题:
                      <%=ForumUtils.GetThreadCount(743)%></em>，<em>帖数:
                      <%=ForumUtils.GetPostCount(743)%></em></dd><dd><%=ForumUtils.GetLastDate(743)%></dd></dl></td><td class="fl_g" align="left" valign="top" style="width:33.3%;"><div class="fl_icn_g"><a href="/BBS/forums/744.aspx">
<%if (ForumUtils.IsNewThread(744)){%><img src="../images/forum_new.gif" /><%}else{%><img src="../images/forum.gif" /><%}%>
</a></div><dl><dt><a href="/BBS/forums/744.aspx"><strong>安装与升级</strong></a><em class="xi1"> 
                    (<%=ForumUtils.GetTodayThreadAndPostCount(744)%>)
                     </em></dt><dd><em>主题:
                      <%=ForumUtils.GetThreadCount(744)%></em>，<em>帖数:
                      <%=ForumUtils.GetPostCount(744)%></em></dd><dd><%=ForumUtils.GetLastDate(744)%></dd></dl></td><td class="fl_g" align="left" valign="top" style="width:33.3%;"><div class="fl_icn_g"><a href="/BBS/forums/745.aspx">
<%if (ForumUtils.IsNewThread(745)){%><img src="../images/forum_new.gif" /><%}else{%><img src="../images/forum.gif" /><%}%>
</a></div><dl><dt><a href="/BBS/forums/745.aspx"><strong>产品发展建议</strong></a><em class="xi1"> 
                    (<%=ForumUtils.GetTodayThreadAndPostCount(745)%>)
                     </em></dt><dd><em>主题:
                      <%=ForumUtils.GetThreadCount(745)%></em>，<em>帖数:
                      <%=ForumUtils.GetPostCount(745)%></em></dd><dd><%=ForumUtils.GetLastDate(745)%></dd></dl></td>
	</tr>
</table></div></div>
        <!--子版块结束-->
        ...
        <td><div class="popoutContent">
            <div style="width:320px;">
              ...
              <div class="popContent">
                <p> <strong><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/delete.aspx?action=DeleteThread&forumID=742' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),260, 300, '删除主题', '');}return false;" class="xg3" href="javascript:;">删除</a></strong> <span class="pipe">|</span><strong><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/translate.aspx?forumID=742' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '移动主题', '');}return false;" class="xg3" href="javascript:;">移动</a></strong> <span class="pipe">|</span><strong><a onclick="failureMessage('该板块没有设置主题分类');" class="xg3" href="javascript:;">分类</a></strong> </p>
                <p> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=top&forumID=742' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">置顶</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=digest&forumID=742' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">精华</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=highlight&forumID=742' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">高亮</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/upDown.aspx?forumID=742' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '提升下沉', '');}return false;" class="xg3" href="javascript:;">升降</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/lock.aspx?forumID=742' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '锁定', '');}return false;" class="xg3" href="javascript:;">锁定</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/ban.aspx?forumID=742&action=BanThreads' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '屏蔽帖子', '');}return false;" class="xg3" href="javascript:;">屏蔽</a> </p>
              </div>
              <div class="popBottom">
                <label>
...
<script type="text/javascript" language="javascript">document.ondblclick=function(x){location.href = 'http://www.dev.com/siteserver/bbs/background_utils.aspx?type=CreatePage&directoryName=template&fileName=forum.aspx&forumID=742';}</script>