...
<head>
<title>教程发布中心 - SiteServer BBS 论坛 - Powered by SiteServer BBS</title>
...
function gotoAdvancedUrl() {
    ...
    location.href = '/BBS/post.aspx?forumID=749';
}
KE.show({
    id : 'content',
...
<div class="hd">
    ...
    <div class="share_p"><img src="../images/ico_position.gif" />
            <a href="/BBS/">SiteServer BBS 论坛</a>><a href="/BBS/forums/746.aspx">SiteServer CMS内容管理系统</a>><a href="/BBS/forums/749.aspx">教程发布中心</a>
          </div>
  </div>
        <!--子版块开始-->
        ...
        版主: <span class="f_c">
        <a href="post.aspx">admin</a></span>      </p>--><div class="y thread_right"><div><!--<img src="../images/favour.gif" /><a href="#" class="favour">收藏</a> --><img src="../images/forumdigest.gif" /><a href="../rss.aspx?forumID=749" target="_blank" class="digest">订阅</a><img src="../images/icon_feed.gif" /><a href="../my/permission.aspx?forumID=749" class="feed">权限</a></div><div>版主：<span class="moderator"></span></div></div><div class="y thread_left"><h1>教程发布中心</h1><span class="left">今日: <strong class="xi1"><%=this.forumInfo.TodayPostCount + this.forumInfo.TodayThreadCount%></strong><span class="pipe">|</span>主题: <strong class="xi1"><%=this.forumInfo.TodayThreadCount%></strong><span class="pipe">|</span>帖子: <strong class="xi1"><%=this.forumInfo.TodayPostCount%></strong></span><p></p></div><div class="thread_line"></div><div class="explan_font"><span class="y"><img id="arrow_summary" onClick="$('#summary').toggle();" style="cursor:pointer" src="../images/arrow_u.gif" border="0" /></span><div id="summary"></div><br /></div></div><div class="post_bar"><div class="post_function"><span class="posting" id="posting1"><a href="/BBS/post.aspx?forumID=749">发 帖</a></span></div><%if (base.pagerInfo != null){%>
<div class="page_out">
...
<%if (base.isModerator){%><tr class="ts"><td> </td><th>管理主题</th><td> </td><td> </td><td> </td></tr><tr><td class="folder" style="width:50px;"><label for="pw_sel_all" class="fl mr5"><input name="chkall" id="pw_sel_all" autocomplete="off" type="checkbox" onclick="threadManager.checkall(this)" />
                        &nbsp;全选</label></td><td colspan="4"><P><strong><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/delete.aspx?action=DeleteThread&forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),260, 300, '删除主题', '');}return false;" class="xg3" href="javascript:;">删除</a></strong><span class="pipe">|</span><strong><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/translate.aspx?forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '移动主题', '');}return false;" class="xg3" href="javascript:;">移动</a></strong><span class="pipe">|</span><strong><a onclick="failureMessage('该板块没有设置主题分类');" class="xg3" href="javascript:;">分类</a></strong><span class="pipe">|</span><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=top&forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">置顶</a><span class="pipe">|</span><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=digest&forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">精华</a><span class="pipe">|</span><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=highlight&forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">高亮</a><span class="pipe">|</span><a onclick="" class="xg3" href="javascript:;">提升/下沉</a><span class="pipe">|</span><a onclick="" class="xg3" href="javascript:;">锁定/关闭</a></P></td></tr><%}%>
</table></div><div class="post_bar"><div class="post_function"><span class="posting" id="posting2"><a href="/BBS/post.aspx?forumID=749">发 帖</a></span></div><%if (base.pagerInfo != null){%>
<div class="page_out">
  <div class="pagination">
    <div class="page_right">
      <%if (base.pagerInfo.Page > 1){%>
        ...
        <td><div class="popoutContent">
            <div style="width:320px;">
              ...
              <div class="popContent">
                ...
                <p> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=top&forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">置顶</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=digest&forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">精华</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=highlight&forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">高亮</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/upDown.aspx?forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '提升下沉', '');}return false;" class="xg3" href="javascript:;">升降</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/lock.aspx?forumID=749' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '锁定', '');}return false;" class="xg3" href="javascript:;">锁定</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/ban.aspx?forumID=749&action=BanThreads' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '屏蔽帖子', '');}return false;" class="xg3" href="javascript:;">屏蔽</a> </p>
              </div>
              <div class="popBottom">
                <label>
...
<script type="text/javascript" language="javascript">document.ondblclick=function(x){location.href = 'http://www.dev.com/siteserver/bbs/background_utils.aspx?type=CreatePage&directoryName=template&fileName=forum.aspx&forumID=749';}</script>