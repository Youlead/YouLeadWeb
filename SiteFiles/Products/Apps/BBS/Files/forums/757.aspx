...
<head>
<title>Siteserver Space个人空间系统 - SiteServer BBS 论坛 - Powered by SiteServer BBS</title>
...
function gotoAdvancedUrl() {
    ...
    location.href = '/BBS/post.aspx?forumID=757';
}
KE.show({
    id : 'content',
...
<div class="hd">
    ...
    <div class="share_p"><img src="../images/ico_position.gif" />
            <a href="/BBS/">SiteServer BBS 论坛</a>><a href="/BBS/forums/757.aspx">Siteserver Space个人空间系统</a>
          </div>
  </div>
        <!--子版块开始-->
        <div class="share_area sha_bot_line" style="margin-bottom:10px;"><div class="share_tit"><span class="y"></span><h2><a href="/BBS/forums/757.aspx">Siteserver Space个人空间系统</a></h2></div><div class="share_table sha_bot_line"><table cellspacing="0" align="Center" style="width:100%;border-collapse:collapse;">
	<tr>
		<td class="fl_g" align="left" valign="top" style="width:33.3%;"><div class="fl_icn_g"><a href="/BBS/forums/758.aspx">
<%if (ForumUtils.IsNewThread(758)){%><img src="../images/forum_new.gif" /><%}else{%><img src="../images/forum.gif" /><%}%>
</a></div><dl><dt><a href="/BBS/forums/758.aspx"><strong>Siteserver Space答疑</strong></a><em class="xi1"> 
                    (<%=ForumUtils.GetTodayThreadAndPostCount(758)%>)
                     </em></dt><dd><em>主题:
                      <%=ForumUtils.GetThreadCount(758)%></em>，<em>帖数:
                      <%=ForumUtils.GetPostCount(758)%></em></dd><dd><%=ForumUtils.GetLastDate(758)%></dd></dl></td><td class="fl_g" align="left" valign="top" style="width:33.3%;"><div class="fl_icn_g"><a href="/BBS/forums/759.aspx">
<%if (ForumUtils.IsNewThread(759)){%><img src="../images/forum_new.gif" /><%}else{%><img src="../images/forum.gif" /><%}%>
</a></div><dl><dt><a href="/BBS/forums/759.aspx"><strong>系统BUG报告</strong></a><em class="xi1"> 
                    (<%=ForumUtils.GetTodayThreadAndPostCount(759)%>)
                     </em></dt><dd><em>主题:
                      <%=ForumUtils.GetThreadCount(759)%></em>，<em>帖数:
                      <%=ForumUtils.GetPostCount(759)%></em></dd><dd><%=ForumUtils.GetLastDate(759)%></dd></dl></td><td></td>
	</tr>
</table></div></div>
        <!--子版块结束-->
        ...
        <td><div class="popoutContent">
            <div style="width:320px;">
              ...
              <div class="popContent">
                <p> <strong><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/delete.aspx?action=DeleteThread&forumID=757' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),260, 300, '删除主题', '');}return false;" class="xg3" href="javascript:;">删除</a></strong> <span class="pipe">|</span><strong><a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/translate.aspx?forumID=757' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '移动主题', '');}return false;" class="xg3" href="javascript:;">移动</a></strong> <span class="pipe">|</span><strong><a onclick="failureMessage('该板块没有设置主题分类');" class="xg3" href="javascript:;">分类</a></strong> </p>
                <p> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=top&forumID=757' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">置顶</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=digest&forumID=757' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">精华</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/highlight.aspx?action=highlight&forumID=757' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),460, 400, '主题管理', '');}return false;" class="xi1" href="javascript:;">高亮</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/upDown.aspx?forumID=757' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '提升下沉', '');}return false;" class="xg3" href="javascript:;">升降</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/lock.aspx?forumID=757' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '锁定', '');}return false;" class="xg3" href="javascript:;">锁定</a> <span class="pipe">|</span> <a onclick="if (!alertCheckBoxCollection(document.getElementsByName('threadIDArray'), '请选择主题进行操作')){showDialog('/BBS/dialog/ban.aspx?forumID=757&action=BanThreads' + '&threadIDArray=' + getCheckBoxCollectionValue(document.getElementsByName('threadIDArray')),300, 360, '屏蔽帖子', '');}return false;" class="xg3" href="javascript:;">屏蔽</a> </p>
              </div>
              <div class="popBottom">
                <label>
...
<script type="text/javascript" language="javascript">document.ondblclick=function(x){location.href = 'http://www.dev.com/siteserver/bbs/background_utils.aspx?type=CreatePage&directoryName=template&fileName=forum.aspx&forumID=757';}</script>