...
<head>
<title>版块二 - SiteServer BBS 论坛 - Powered by SiteServer BBS</title>
...
function gotoAdvancedUrl() {
    ...
    location.href = '/bbs_test/post.aspx?forumID=9';
}
KE.show({
    id : 'content',
...
<div class="hd">
    ...
    <div class="share_p"><img src="../images/ico_position.gif" />
            <a href="/bbs_test">SiteServer BBS 论坛</a>><a href="/bbs_test/forums/9.aspx">版块二</a>
          </div>
  </div>
        <!--子版块开始-->
        <div class="share_area sha_bot_line" style="margin-bottom:10px;"><div class="share_tit"><span class="y"></span><h2><a href="/bbs_test/forums/9.aspx">版块二</a></h2></div><div class="share_table sha_bot_line"><table cellspacing="0" cellpadding="0" width="100%"><tr><td width="68%" class="fl_g"><div class="fl_icn_g"><a href="/bbs_test/forums/10.aspx">
<%if (ForumUtils.IsNewThread(10)){%><img src="../images/forum_new.gif" /><%}else{%><img src="../images/forum.gif" /><%}%>
</a></div><dl><dt style="padding-top:10px;"><a href="/bbs_test/forums/10.aspx"><strong>下级版块1</strong></a><em class="xw0 xi1"> 
                        (<%=ForumUtils.GetTodayThreadAndPostCount(10)%>)
                         </em></dt></dl></td><td width="10%" class="fl_g"><em><%=ForumUtils.GetThreadCount(10)%></em> / <%=ForumUtils.GetPostCount(10)%></td><td width="21%" class="fl_g"><p><%=ForumUtils.GetLastTitle(10)%></p><div class="topicbackwriter"><%=ForumUtils.GetLastUserNameAndTime(10)%></div></td></tr><tr><td width="68%" class="fl_g"><div class="fl_icn_g"><a href="/bbs_test/forums/11.aspx">
<%if (ForumUtils.IsNewThread(11)){%><img src="../images/forum_new.gif" /><%}else{%><img src="../images/forum.gif" /><%}%>
</a></div><dl><dt style="padding-top:10px;"><a href="/bbs_test/forums/11.aspx"><strong>下级版块2</strong></a><em class="xw0 xi1"> 
                        (<%=ForumUtils.GetTodayThreadAndPostCount(11)%>)
                         </em></dt></dl></td><td width="10%" class="fl_g"><em><%=ForumUtils.GetThreadCount(11)%></em> / <%=ForumUtils.GetPostCount(11)%></td><td width="21%" class="fl_g"><p><%=ForumUtils.GetLastTitle(11)%></p><div class="topicbackwriter"><%=ForumUtils.GetLastUserNameAndTime(11)%></div></td></tr><tr><td width="68%" class="fl_g"><div class="fl_icn_g"><a href="/bbs_test/forums/12.aspx">
<%if (ForumUtils.IsNewThread(12)){%><img src="../images/forum_new.gif" /><%}else{%><img src="../images/forum.gif" /><%}%>
</a></div><dl><dt style="padding-top:10px;"><a href="/bbs_test/forums/12.aspx"><strong>下级版块3</strong></a><em class="xw0 xi1"> 
                        (<%=ForumUtils.GetTodayThreadAndPostCount(12)%>)
                         </em></dt></dl></td><td width="10%" class="fl_g"><em><%=ForumUtils.GetThreadCount(12)%></em> / <%=ForumUtils.GetPostCount(12)%></td><td width="21%" class="fl_g"><p><%=ForumUtils.GetLastTitle(12)%></p><div class="topicbackwriter"><%=ForumUtils.GetLastUserNameAndTime(12)%></div></td></tr></table></div></div>
        <!--子版块结束-->
