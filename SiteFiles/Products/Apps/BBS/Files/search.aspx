...
<div id="ajaxLoading" style="position:absolute">请稍后...</div>
    ...
    <div class="hd">
        ...
        <div class="main thread"><div class="post_bar"><div class="post_function"><form action="/bbs_test/search.aspx"><table border="0" cellspacing="2" cellpadding="2" width="500"><tr><td width="400"><input type="text" id="word" name="word" value="<%=base.word%>" class="searchIpt" /></td><td width="100" align="right" valign="middle"><input type="submit" class="regi_button" value="搜 索" /></td></tr></table></form></div><%if (base.pagerInfo != null){%>
<div class="page_out">
...
<%}%>
</div><div class="nav_thread"><ul><li class="thr_current"><asp:Literal ID="ltlText" runat="server"></asp:Literal></li></ul><div class="nav_rig_info"><a href="?type=digest">精华</a> | <a href="?type=image">图片贴</a>&nbsp;&nbsp;</div></div><div class="th"><table cellspacing="0" cellpadding="0" class="th"><tr><td width="66%"><div class="tf"> 排序:
...
<span class="pipe">|</span>类型: <a href="#" class="xi4">全部主题</a><a href="#" class="showmenu">投票</a></div></td><td width="14%" class="by">&nbsp;&nbsp;&nbsp;作者</td><td width="6%" class="num">&nbsp;回复</td><td width="14%" class="by">&nbsp;最后发表</td></tr></table></div><div class="thread_out" style="border:1px solid #dadada;padding:10px; background:url(images/info_table_bg.gif) repeat-x left top;"><table border="0" class="info_table"><asp:repeater ID="rptThreads" runat="server"><itemtemplate><asp:Literal ID="ltlTr" runat="server"></asp:Literal><td class="folder"><asp:Literal ID="ltlIcon" runat="server"></asp:Literal></td><th class="new" id="title_<%#DataBinder.Eval(Container.DataItem,"id")%>" width="65%"><asp:Literal ID="ltlTitle" runat="server"></asp:Literal></th><td width="14%" class="by"><em><asp:HyperLink ID="hlUserName" runat="server"></asp:HyperLink></em><div class="thread_number"><asp:Literal ID="ltlAddDate" runat="server"></asp:Literal></div></td><td width="6%" class="num"><asp:HyperLink ID="hlReplies" CssClass="xg3" runat="server"></asp:HyperLink><div class="thread_number"> <%#DataBinder.Eval(Container.DataItem,"hits")%> </div></td><td width="14%" class="by"><em><asp:HyperLink ID="hlLastUserName" runat="server"></asp:HyperLink></em><div class="thread_number"><asp:Literal ID="ltlLastDate" runat="server"></asp:Literal></div></td><asp:PlaceHolder ID="phContent" runat="server"><tr><td class="folder"></td><td colspan="6" class="grayTxt"><asp:Literal ID="ltlContent" runat="server"></asp:Literal></td></tr></asp:PlaceHolder></itemtemplate></asp:repeater></table></div><div class="post_bar"><%if (base.pagerInfo != null){%>
<div class="page_out">
  <div class="pagination">
    <div class="page_right">
      <%if (base.pagerInfo.Page > 1){%>
