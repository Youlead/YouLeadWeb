var orderService = {};
orderService.baseUrl = $pageInfo.rootUrl + '/api/order/';
...
orderService.getOrderList = function (isCompleted, isPayment, success) {
    var param = '&isCompleted=' + isCompleted + '&isPayment=' + isPayment;
