...
orderListController.render = function(){
  utilService.render('orderListController', orderListController);
};

orderListController.getOrderList = function(){
    orderService.getOrderList(orderListController.isCompleted, orderListController.isPayment, function(data){
